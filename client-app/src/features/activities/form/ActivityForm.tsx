            ...
            <Grid.Column width={10}>
                <Segment clearing>
                    <Form>
                        ...
                        <Button loading={submitting} onClick={handleSubmit} floated='right' positive type='sunmit' content='Submit' />
                        <Button onClick={() => history.push('/activities')} floated='right' type='sbuttonunmit' content='Cancel' />
                    </Form>
                </Segment>
            </Grid.Column>
        </Grid>
